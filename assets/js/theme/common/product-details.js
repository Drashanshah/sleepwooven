...
import { initCustomSizeListener } from '../common/select-custom-size';
...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        const $customSizeOptionsElement = $('.form-custom-size-container', $scope);
        initCustomSizeListener($customSizeOptionsElement);
